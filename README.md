...
Tap the logo button in the bottom nav to enter Fly Mode — a full-screen scoreboard showing only your followed teams’ live matches, with a skull marker on rivalry games. Brightness slider at the bottom. Tap anywhere to exit.
